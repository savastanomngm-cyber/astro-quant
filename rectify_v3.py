...
ASSET_EVENTS = {
    "NQ": [
        ("1999-03-10", "NASDAQ hits 5000", "sun", "", 0.7, ""),
        ("2000-03-10", "Dot-com peak 5048", "venus", "", 0.8, "Venus subperiod"),
        ("2002-10-09", "Dot-com bottom 1114", "saturn", "", 0.8, ""),
        ("2008-11-20", "GFC low 1018", "saturn", "", 0.8, "Saturn subperiod"),
        ("2011-11-25", "Euro crisis low", "saturn", "", 0.6, ""),
        ("2014-04-04", "Momentum crash low", "mars", "", 0.6, ""),
        ("2018-12-24", "Xmas Eve crash", "mars", "", 0.7, ""),
        ("2020-03-23", "COVID low 6629", "moon", "", 0.8, "Moon subperiod"),
        ("2021-11-19", "All-time high", "jupiter", "", 0.7, ""),
        ("2022-10-13", "NASDAQ 2022 low", "sun", "MC_square", 1.0, "Sun→MC sq ±73d"),
        ("2022-10-13", "2022 low (nodal)", "", "", 1.0, "NN→MC ±38d"),
        ("2023-10-26", "2023 correction low", "mars", "", 0.6, ""),
        ("2024-02-22", "AI rally record", "sun", "", 0.7, ""),
    ],
    "ES": [
        ("1987-10-19", "Black Monday -22%", "mars", "", 1.0, "Mars major period"),
        ("1990-07-16", "1990 recession bottom", "saturn", "", 0.7, ""),
        ("1998-07-20", "LTCM crisis peak", "venus", "", 0.7, ""),
        ("2000-03-24", "Dot-com peak 1527", "venus", "", 0.8, ""),
        ("2002-10-09", "Dot-com bottom 777", "saturn", "", 0.8, ""),
        ("2007-10-09", "Pre-GFC high 1565", "saturn", "", 0.8, ""),
        ("2009-03-09", "GFC bottom 666", "mars", "", 0.8, ""),
        ("2011-10-03", "Euro debt crisis low", "saturn", "", 0.7, ""),
        ("2015-08-24", "Flash crash low", "mars", "", 0.7, ""),
        ("2018-12-24", "Xmas Eve crash", "mars", "", 0.7, ""),
        ("2020-03-23", "COVID low 2191", "moon", "", 0.8, ""),
        ("2022-01-04", "All-time high 4818", "jupiter", "", 0.7, ""),
        ("2022-10-12", "2022 low 3491", "saturn", "", 0.7, ""),
        ("2023-10-27", "2023 correction low", "mars", "", 0.6, ""),
        ("2024-12-06", "Record high 6090", "sun", "", 0.7, ""),
    ],
    "GC": [
